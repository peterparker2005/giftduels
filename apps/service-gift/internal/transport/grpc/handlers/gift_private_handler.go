...
import (
	...
	"github.com/peterparker2005/giftduels/apps/service-gift/internal/adapter/proto"
...
func (h *giftPrivateHandler) PrivateGetGifts(
	...
	for i, g := range gifts {
		giftProtos[i] = proto.DomainGiftToProto(g)
	}
...
func (h *giftPrivateHandler) GetUserGifts(
	...
	for i, g := range domainGifts.Gifts {
		giftViews[i] = proto.DomainGiftToProto(g)
	}
...
func (h *giftPrivateHandler) StakeGift(
	...
	return &giftv1.StakeGiftResponse{
		Gift: proto.DomainGiftToProto(g),
	}, nil
}
