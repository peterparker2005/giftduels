...
func NewGiftRepo(pool *pgxpool.Pool) gift.GiftRepository {
	return &GiftRepository{pool: pool, q: sqlc.New(pool)}
}
...
func (r *GiftRepository) GetUserGifts(ctx context.Context, limit, offset int32, ownerTelegramID int64) ([]*gift.Gift, error) {
