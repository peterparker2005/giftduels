module github.com/peterparker2005/giftduels/apps/service-identity
...
require (
	...
	github.com/peterparker2005/giftduels/packages/errors v0.0.0-20250706093708-5d489ad138ec
